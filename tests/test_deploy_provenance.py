...
HOTFIX_FILES = {
    ...
    "docs/evidence_vault_sv9_assessment_adr_v3.md",
    ...
    "src/services/scanner_score_publication.py",
    "src/sv9/aggregator.py",
    ...
    "tests/test_evidence_vault_receipt_evidence_cardinality_migration.py",
    ...
    "tests/test_scanner_api_v1.py",
    "tests/test_scanner_evidence_comparison.py",
    "tests/test_sv9_assessment_kernel.py",
    "tests/test_sv9_evaluator.py",
    "tests/test_sv9_export_md.py",
    ...
    "tests/test_vault_sv9_parity.py",
    "tests/test_web_lab.py",
    "web/api_v1/models.py",
    "web/api_v1/presenters.py",
    "web/api_v1/router.py",
    "web/app.py",
    "web/report_store.py",
    "web/report_view_model.py",
    "web/scan_runner.py",
